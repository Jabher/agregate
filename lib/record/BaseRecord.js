...
export default class BaseRecord extends MetadataClass {
    static get label() { return this.name }

    static fromNode(node) { return new this(this.getReflectableProps(node), {node}) }
    ...
    get uuid() { return this.metadata.node ? this.metadata.node.uuid : undefined }

    get createdAt() { return this.metadata.node ? this.metadata.node.createdAt : undefined }

    get updatedAt() { return this.metadata.node ? this.metadata.node.updatedAt : undefined }
    ...
    async save() {
        ...
        Object.assign(this, internalInstance.toJSON())
        Object.assign(this, this.constructor.getReflectableProps(entry))
